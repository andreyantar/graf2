  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ x, y, rotate }}
        className="select-none cursor-grab rounded-full bg-[--color-fg] text-[--color-bg] px-7 py-4 min-h-[44px] inline-flex items-center text-body shadow-[0_12px_40px_-12px_rgba(0,0,0,0.4)]"
      >
        ↳ drag me · {label}
      </motion.div>
    </div>
